...
function ProductDestructionPage() {
  return (
    <ServicePageTemplate
      ...
      related={[
        { title: "Document Shredding", body: "Secure shredding of sensitive documents.", img: imgShred, to: "/services/document-shredding", icon: FileText },
        ...
        { title: "Dumpster Rental", body: "Dumpster rental for cleanouts and projects.", img: imgDumpster, to: "/services/dumpster-rental", icon: Building2 },
      ]}
    />
  );
}
