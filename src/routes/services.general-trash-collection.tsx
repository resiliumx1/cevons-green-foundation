...
export const Route = createFileRoute("/services/general-trash-collection")({
  head: () => ({
    ...
    scripts: serviceJsonLdScripts({ name: PAGE_TITLE, description: PAGE_DESC, path: PAGE_URL, breadcrumb: "General Trash Collection", category: "Residential", faqs }),
  }),
  component: Page,
});
...
const detailSections: DetailSection[] = [
  {
    ...
    images: [
      { src: wheelieBinAsset.url, alt: "CEVONS orange rear-loader garbage collection truck on a Guyana residential street", fit: "cover" },
    ],
  },
  {
    variant: "gallery",
