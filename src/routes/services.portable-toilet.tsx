...
export const Route = createFileRoute("/services/portable-toilet")({
  head: () => ({
    ...
    scripts: serviceJsonLdScripts({ name: PAGE_TITLE, description: PAGE_DESC, path: PAGE_URL, breadcrumb: "Portable Toilet", category: "Sanitation", faqs }),
  }),
  component: Page,
});
...
const detailSections: DetailSection[] = [
  {
    ...
    images: [
      { src: toiletTruckAsset.url, alt: "CEVONS service truck transporting a sealed vacuum tank and red portable toilet unit", fit: "contain", bg: "#FFFFFF" },
    ],
  },
  {
    variant: "gallery",
