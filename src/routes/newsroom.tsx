        ...
        <div className="container-cevons relative min-h-[300px] md:min-h-[380px] flex flex-col justify-center py-16 md:py-20">
          <nav aria-label="Breadcrumb" className="mb-5">
            <ol className={`flex items-center gap-1.5 text-xs md:text-sm text-white/80 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}>
              ...
              <li aria-current="page" className="text-[var(--cevons-yellow,#FCE722)] font-semibold">Newsroom</li>
            </ol>
          </nav>
      ...
      >
        <div className="container-cevons">
          <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
            <span className="block text-xs md:text-sm font-semibold uppercase tracking-[0.28em] text-[var(--brand-orange)] mb-3">
              Our Journey
            </span>
            <h2
            ...
            <div aria-hidden className="mt-5 mx-auto h-[3px] w-20 rounded-full bg-[var(--brand-orange)]" />
          </div>
                ...
                return (
                  ...
                  >
                        ...
                        {year ? (
                          <span
                            className={`px-4 py-1 text-sm font-bold rounded-full ${
                              replace ? "bg-[#1A1A1A] text-white" : "bg-[var(--brand-orange)] text-white"
                            }`}
                          >
                            {year}
                          </span>
                    ...
                    <div className="absolute left-4 md:left-1/2 top-1 md:top-1/2 -translate-x-1/2 md:-translate-y-1/2 z-10">
                      ...
                      >
                        <Icon
                          className={`w-4 h-4 ${replace ? "text-[#1A1A1A]/60 dark:text-white/60" : "text-[var(--brand-orange)]"}`}
                          strokeWidth={2.5}
                          aria-hidden="true"
                        />
                      </div>
