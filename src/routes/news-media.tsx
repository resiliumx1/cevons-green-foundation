...
import { usePublishedMedia, aspectRatio, mediaImageStyle, type ResolvedMediaPost } from "@/lib/mediaPosts";
  ...
  return (
    <figure className="mb-4 break-inside-avoid overflow-hidden card-cevons rounded-xl p-0">
      <img
        ...
        style={{ aspectRatio: aspectRatio(item.image_w, item.image_h), ...mediaImageStyle(item) }}
      />
