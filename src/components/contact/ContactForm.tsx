...
const inputClass =
  "w-full rounded-xl border border-[var(--cevons-border,#E5E7EB)] bg-white px-4 py-3 text-sm text-[var(--cevons-dark,#101820)] placeholder:text-[var(--cevons-muted,#64748B)]/60 focus:outline-none focus:ring-2 focus:ring-[var(--cevons-deep-green,var(--brand-orange))]/30 focus:border-[var(--cevons-deep-green,var(--brand-orange))] transition";
const inputErrClass =
...
export function ContactForm() {
  ...
  if (stage === "success" && result) {
    ...
    const waUrl = whatsappHref.includes("?")
      ...
      : `${whatsappHref}?text=${waMsg}`;
    return (
      <div ref={panelRef} aria-live="polite" className="rounded-2xl border border-[var(--cevons-deep-green,var(--brand-orange))]/20 bg-white shadow-lg overflow-hidden">
        <div className="bg-gradient-to-br from-[var(--cevons-deep-green,var(--brand-orange))] to-[#1A1A1A] px-6 py-10 text-center">
        ...
        <div className="px-6 py-7 space-y-5">
          <div className="rounded-xl border border-[var(--cevons-deep-green,var(--brand-orange))]/15 bg-[var(--cevons-cream,#FBF7EE)] px-5 py-4 flex items-center justify-between gap-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--cevons-muted,#64748B)]">Reference</p>
              <p className="mt-1 font-mono text-xl font-bold text-[var(--cevons-deep-green,var(--brand-orange))]">{result.reference}</p>
            </div>
            <button
              type="button"
              onClick={copyRef}
              className="inline-flex items-center gap-2 rounded-lg border border-[var(--cevons-deep-green,var(--brand-orange))]/30 bg-white px-3 py-2 text-sm font-semibold text-[var(--cevons-deep-green,var(--brand-orange))] hover:bg-[var(--cevons-deep-green,var(--brand-orange))] hover:text-white transition"
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="button"
              onClick={reset}
              className="btn-base flex-1 justify-center py-3 border-2 border-[var(--cevons-deep-green,var(--brand-orange))] text-[var(--cevons-deep-green,var(--brand-orange))] hover:bg-[var(--cevons-deep-green,var(--brand-orange))] hover:text-white transition"
            >
  ...
  if (stage === "duplicate" && result) {
    ...
    return (
      <div ref={panelRef} aria-live="polite" className="rounded-2xl border border-[var(--brand-orange-dark)]/30 bg-white shadow-lg overflow-hidden">
        <div className="bg-gradient-to-br from-[var(--brand-orange)] to-[var(--brand-orange-dark)] px-6 py-10 text-center">
      ...
      {showConfirm && (
        ...
        >
          <div ref={dialogRef} className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col animate-[slideUp_0.25s_ease-out]">
            <div className="px-6 py-5 bg-[var(--cevons-deep-green,var(--brand-orange))] text-white flex items-center justify-between">
              <div>
            ...
            <div className="px-6 py-4 border-t border-[var(--cevons-border,#E5E7EB)] bg-white flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
              <button type="button" onClick={() => setShowConfirm(false)} disabled={submitting}
                className="btn-base px-5 py-2.5 border-2 border-[var(--cevons-deep-green,var(--brand-orange))] text-[var(--cevons-deep-green,var(--brand-orange))] hover:bg-[var(--cevons-deep-green,var(--brand-orange))]/5 disabled:opacity-50">
