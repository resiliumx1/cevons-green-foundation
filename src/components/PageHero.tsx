...
export function PageHero({
  ...
  const overlay =
    align === "center"
      ? "linear-gradient(180deg, rgba(15,15,15,0.45) 0%, rgba(15,15,15,0.18) 30%, rgba(15,15,15,0.00) 55%), linear-gradient(180deg, rgba(15,15,15,0.82) 0%, rgba(15,15,15,0.55) 60%, rgba(15,15,15,0.30) 100%)"
      : "linear-gradient(180deg, rgba(15,15,15,0.45) 0%, rgba(15,15,15,0.18) 30%, rgba(15,15,15,0.00) 55%), linear-gradient(90deg, rgba(15,15,15,0.92) 0%, rgba(15,15,15,0.72) 45%, rgba(15,15,15,0.30) 100%)";
