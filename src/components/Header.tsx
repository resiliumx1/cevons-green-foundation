    ...
    >
      <div className="container-cevons flex h-[72px] items-center gap-4">
                  ...
                  <div className="bg-white rounded-xl border border-cevons-border shadow-[0_20px_40px_rgba(16,24,32,0.12)] p-4 min-w-[260px]">
                    <ul className="space-y-1">
                      ...
                      <li>
                        <span
                          aria-disabled="true"
                          className="flex items-center justify-between px-3 py-2 -mx-2 text-[13px] text-cevons-dark rounded-md opacity-50 cursor-default select-none"
                        >
                          <span className="flex flex-col">
        ...
        <div className="hidden lg:flex items-center gap-2 shrink-0">
          <SiteSearch />
          <SettingsMenu />
          <a href="/request-service" className="btn-base btn-green btn-inviting group/sched text-[13.5px] px-4 py-2.5 shrink-0">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3 px-1">
              <a href="/request-service" className="btn-base btn-green btn-inviting group/sched w-full">
                <Calendar className="size-4 transition-transform duration-300 group-hover/sched:-rotate-6 group-hover/sched:scale-110" />
