...
const quickActions: SearchEntry[] = [
  ...
  { id: "qa-sizes", name: "Skip bin sizes", desc: "Compare 10 cu yd skip bins and 20 cu yd roll-off dumpsters.", to: "/services/skip-bin-dumpster-rental", group: "Quick actions", keywords: ["size", "sizes", "10", "20", "cubic"] },
